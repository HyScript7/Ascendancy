...
import io.github.hyscript7.ascendancy.api.data.value.DataBoolean;
import io.github.hyscript7.ascendancy.api.data.value.DataBytes;
import io.github.hyscript7.ascendancy.api.data.value.DataDecimal;
import io.github.hyscript7.ascendancy.api.data.value.DataInteger;
import io.github.hyscript7.ascendancy.api.data.value.DataList;
import io.github.hyscript7.ascendancy.api.data.value.DataMap;
import io.github.hyscript7.ascendancy.api.data.value.DataString;
